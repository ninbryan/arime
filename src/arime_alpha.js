...
function outputMath(method) {
	var inputs = doc.getAll('input'),
		i1 = inputs[0].value,
		i2 = inputs[1].value;
	doc.get('textarea[name=textarea]').innerHTML = sMath[method](i1, i2);
	doc.get('textarea[name=textarea2]').innerHTML = jsMath[method](i1, i2);
}
var sMath = (function() {
